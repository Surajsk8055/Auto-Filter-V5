...
API_ID = int(environ.get('API_ID', '29268135'))
API_HASH = environ.get('API_HASH', '2679905ff7594ae3ef5ef1564abd0221')
BOT_TOKEN = environ.get('BOT_TOKEN', "6104730624:AAEj7MlRZR4ZuOC4L2bkUC09Po28PtBVtcg")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5722838048').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001920905708').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://surajchoubes856:<password>@cluster0.552cemi.mongodb.net/?retryWrites=true&w=majority
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/badshaofmovie')
...
# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001725044390))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001920905708))
...
# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001929928412))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001929928412))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '02f94b03c81f2d08a46720e6d2582881586abda4')
